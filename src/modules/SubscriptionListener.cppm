...
namespace Lightstreamer::Cpp::SubscriptionListener {
    ...
    public:
        ...
        */
         ...
         * through :meth:`.Subscription.addListener`. This is the first event to be fired on the listener.
        */
        void onListenStart() {}
        ...
        */
        ...
        (see :meth:`.Subscription.setCommandSecondLevelFields` and
         :meth:`.Subscription.setCommandSecondLevelFieldSchema`), second-level subscriptions are not notified.
        */
        void onSubscription() {}
        ...
        */
        ...
        performed multiple times through :meth:`.LightstreamerClient.unsubscribe` and
        :meth:`.LightstreamerClient.subscribe`. This can also happen multiple times in case of automatic
        recovery after a connection restart.
        ...
        If the involved Subscription has a two-level behavior enabled
        (see :meth:`.Subscription.setCommandSecondLevelFields` and
         :meth:`.Subscription.setCommandSecondLevelFieldSchema`)
